...
namespace SecurityAppApi.ActionFilters
{
    public class GlobalExceptionAttribute : ExceptionFilterAttribute
    {
        public override void OnException(HttpActionExecutedContext context)
        {
            ...
            {
                trace.Error(context.Request, "Error Message : " + context.Exception.Message + Environment.NewLine + "Error Inner Exception : " + context.Exception.InnerException, context.Exception);
                throw new HttpResponseException(context.Request.CreateResponse(HttpStatusCode.InternalServerError, context.Exception.InnerException));
            }
        }
    }
}